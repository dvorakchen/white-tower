...
class GameOfLevelScreen extends StatefulWidget {
  final Subject subject;
  const GameOfLevelScreen({super.key, required this.subject});

  @override
  State<GameOfLevelScreen> createState() => _GameOfLevelScreen();
}

class _GameOfLevelScreen extends State<GameOfLevelScreen> {
  // 肺部结构图的空位数据列表
            ...
            child:
                ...
                Center(
                  ...
                  child: Stack(
                    children: <Widget>[
                      Image.asset(
                        'assets/images/lung_diagram.png', // **请替换为你的图片路径**
                        fit: BoxFit.contain,
                      ),
            ...
            child: ElevatedButton(
              onPressed: () => {
                Navigator.of(context).pushReplacement(
                  CupertinoPageRoute(
                    builder: (context) =>
                        GameOfLevelScreen(subject: widget.subject),
                  ),
                ),
              },
              child: Text('Next'),
